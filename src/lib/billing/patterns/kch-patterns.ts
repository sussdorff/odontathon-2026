...
export const kchPatterns: BillingPattern[] = [
  // --- Füllungstherapie ---
  {
    ...
    required: [
      { code: '0010', system: 'GOZ', multiplicity: 'per-case', description: 'Eingehende Untersuchung' },
      { code: '2060', system: 'GOZ', multiplicity: 'per-tooth', description: 'Füllung einflächig' },
      { code: '2197', system: 'GOZ', multiplicity: 'per-tooth', description: 'Adhäsive Befestigung (Dentinadhäsiv)' },
    ],
    optional: [
      ...
      { code: '5000', system: 'GOÄ', multiplicity: 'per-tooth', description: 'Zahnfilm (Röntgendiagnostik)' },
      { code: '1020', system: 'GOZ', multiplicity: 'per-tooth', description: 'Lokale Fluoridierung (Schutzlack)' },
    ],
